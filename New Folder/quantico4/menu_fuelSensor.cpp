...
#define MENU_FUELSENSOR_OPTIONS 4
    ...
    {
        msg = "Reading: "+ String(fuelsensor.value) + unit;
    }
    else
    {
        msg = "Reading: "+ String("OUT LIMITS");//OUT OF LIMITS
    }
    //-------

    sysPrint_lcdPrint(LCD_ROW_1, 0, msg);
