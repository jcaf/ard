...
uint8_t error_mgm(long _delay, uint8_t autoerase, const char *code, String param0)
{
    ...
    {
        row0= -1;
        sysPrint_lcd_serialPrintlnPSTR(row1,0,PSTR("[ERROR: H10.1]"));
    ...
    {
        row0 = row3= -1;
        sysPrint_lcd_serialPrintlnPSTR(row1,0,PSTR("[ERROR:H10.2]"));
    ...
    if (strcmp(code,"H10.3")==0)
    {
        ...
        sysPrint_lcd_serialPrintlnPSTR(row2,0,PSTR("[ERROR:H10.3]"));
    ...
    if (strcmp(code,"H10.4")==0)
    {
        ...
        sysPrint_lcd_serialPrintlnPSTR(row2,0,PSTR("[ERROR:H10.4]"));
