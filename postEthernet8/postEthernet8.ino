...
void setup()
{
    ...
    */
    eth_init();
    client_connected = client.connect(eth_server, 80);
}
...
void loop()
{
  ...
  static int sm0;
   ...
   // Serial.println("cc:" + String(client.connected()));
  ...
  if (sm0 ==0)
  {
    ...
    */
    ...
    //delay(120000);//2 min
    //delay(1000);//2 min (cat /proc/sys/net/ipv4/tcp_fin_timeout = 60s)
}
...
uint8_t eth_uploadData_job(void)
{
    ...
    {
        if (client_connected)//(client.connect(eth_server, 80))
        {
